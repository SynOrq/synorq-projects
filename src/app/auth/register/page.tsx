    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">Ücretsiz hesap oluşturun</p>
        </div>

        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input name="name" label="Ad Soyad" placeholder="Adınız Soyadınız" required />
            <Input name="workspaceName" label="Şirket / Ekip Adı" placeholder="Şirket adı" required />
            <Input name="email" type="email" label="E-posta" placeholder="email@sirket.com" required />
            <Input name="password" type="password" label="Şifre" placeholder="En az 8 karakter" required minLength={8} />
