      ...
      <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-4">
          ...
          <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_220px]">
            ...
            />
            <div className="inline-flex items-center justify-center rounded-lg bg-slate-50 px-4 py-2 text-sm text-slate-500">
        ...
        <div className="mt-6 space-y-3">
          ...
          {filteredItems.map((item) => (
            <Link
              key={item.id}
              href={item.href}
              className="block rounded-xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-indigo-200 hover:bg-white"
            >
