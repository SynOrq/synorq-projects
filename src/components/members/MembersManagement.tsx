        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-center shadow-sm">
              ...
              <div className="text-xs text-slate-500">Toplam üye</div>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-center shadow-sm">
              <div className="text-2xl font-bold text-slate-900">{summary.admins}</div>
              <div className="text-xs text-slate-500">Yönetici</div>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white px-4 py-3 text-center shadow-sm">
              <div className="text-2xl font-bold text-slate-900">{summary.viewers}</div>
              <div className="text-xs text-slate-500">İzleyici</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
        ...
        <section className="rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
            <div>
              <h2 className="text-base font-semibold text-slate-900">Rol Matrisi</h2>
